...
#person_sorter.py
#plays back data from a specified folder and allows you to sort for different people
...
def main(root_dir):
    ...
    dir_names = ['bad_examples' ,'questionable_examples', 'person_ricky', 'person_ji', 'person_alex','person_alistair','person_other']
