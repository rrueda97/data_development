...
threshold = 10 #How many extra frames should result in a new video?
manual = True #flag to count manually
...
def split_video():
	fourcc = cv2.VideoWriter_fourcc(*"MJPG") #video codec (use MJP for Linux)
	frame_rate = 10
	frames_per_video = 30
	rootdir = os.getcwd()
